...
namespace OLSR.Communication
{
    ...
    class InfoReceiver
    {
        ...
        //Variable que controla el Overflow del Buffer
        ...
        /// <summary>
        /// Metodo que busca un mensaje de un usuario en la cola de mensajes
        /// </summary>
        /// <param name="message">Entero con el tipo de mensaje que buscamos</param>
        /// <param name="address">Direccion ip de quien envia el mensaje</param>
        /// <returns>Entero con la posicion donde se encuentra el mensaje</returns>
        ...
        /// </summary>
        /// <param name="m">Mensaje procedente en el paquete</param>
